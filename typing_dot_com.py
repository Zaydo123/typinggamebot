...
global scale_widget
scale_widget = Scale(from_=0, to=1, resolution=.01)
scale_widget.pack()
...
def webdriverS():
    ...
    driver.get("https://typing.com/student/login")


def mainfunc():
    lettersChrome = driver.find_elements_by_class_name("screenBasic-word")
    time.sleep(3)
